...
-- Module  Version: 5.8
--C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n command_fifo_1 -lang vhdl -synth lse -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 32 -width 16 -rwidth 16 -no_enable -pe 10 -pf 30 

-- Tue Jul 21 12:16:25 2020
...
architecture Structure of command_fifo_1 is
...
begin
    ...
    command_fifo_1_0_0: FIFO8KB
        generic map (FULLPOINTER1=> "0b00000111110000", FULLPOINTER=> "0b00001000000000", 
        AFPOINTER1=> "0b00000111010000", AFPOINTER=> "0b00000111100000", 
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of command_fifo_1 is
    for Structure
